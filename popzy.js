...
Popzy.prototype.setFooterContent = (html) => {
...
Popzy.prototype._renderFooterContent = () => {
...
Popzy.prototype._createButton = (title, cssClass, callback) => {
...
Popzy.prototype._getScrollbarWidth = function () {
    ...
    this._getScrollbarWidth.value = scrollbarWidth;
